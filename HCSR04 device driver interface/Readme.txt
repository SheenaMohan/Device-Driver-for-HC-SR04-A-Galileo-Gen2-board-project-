...
In this assignment we have developed a loadable kernel module which initiates two instances of HC-SR04 sensors (named as HCSR_1 and HCSR_2) 
and allows the sensors being accessed as device files in user space.
...
1) To configure the MUX gpio pins:
   ...
   change these value for the respective linux gpio MUX pins used.
	eg : #define GPIO_MUX_1 40    if the linux gpio MUX is 40
	     #define GPIO_MUX_2 70	  if the linux gpio MUX is 56
